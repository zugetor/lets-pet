		...
		$scope.allpet = {
			"allpet": {
				...
				},
				{
					...
					"imgurl": ["img/ลาเต้.jpg", "img/ลาเต้2.jpg"]
				},
				{
					"name": "ตาล",
					"type": "สุนัข",
				...
				},
				{
					...
					"breed": "ฮอลแลนด์ลอป",
					"tag": ["ขี้เซา"],"imgurl": ["img/วินดี้.jpg"]
				},
				{
					"name": "เท็ดดี้",
					"type": "กระต่าย",
					...
					"breed": "เท็ดดี้แบร์",
					"tag": ["ขี้เล่น"],"imgurl": ["img/เท็ดดี้.jpg", "img/เท็ดดี้2.jpg", "img/เท็ดดี้3.jpg"]}
				],
				"other": [{
					"name": "มีมี่",
					"type": "เม่นแคระ",
					...
					"breed": "เฮดจ์ฮอก",
					"tag": ["ขี้กลัว","ขี้เซา"],"imgurl": ["img/มีมี่.jpg", "img/มีมี่2.jpg"]
					},{"name": "โซจิโร่",
					"type": "เม่น",
					"age": 2,
					"gender": "เพศผู้",
					...
					"breed": "-",
					"tag": ["ขี้เซา", "ขี้อ้อน"],"imgurl": ["img/cocoa.jpg", "img/cocoa2.jpg"]}
				]
			}
		};
