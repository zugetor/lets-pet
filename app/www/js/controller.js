		...
		$scope.allpet = {
			"allpet": {
				"dog": [{
					...
					"breed": "บางแก้วผสมไทยหลังอาน", "tag": ["ขี้เล่น", "ขี้อ้อน"], "imgurl": ["img/cocoa.jpg", "img/cocoa2.jpg"], "owner": "มินากิ", "tel": "08235648", "index": 1
				}, {
					"name": "ลัคกี้", "type": "สุนัข", "age": 2, "gender": "Female", "description": "ขนสีขาว ไม่ชอบที่มืด",
					"breed": "พุดเดิ้ล", "tag": ["ขี้เล่น", "ขี้อ้อน"], "imgurl": ["img/Lucky.jpg"], "owner": "โมโมกะ", "tel": "084532657", "index": 2
				}, {
					"name": "ชิโร่", "type": "สุนัข", "age": 5, "gender": "Male", "description": "สีเนื้อ ขนมันเงา ชอบเล่นจานร่อน",
					"breed": "อกิตะ", "tag": ["ขี้เล่น"], "imgurl": ["img/shiro.jpg"], "owner": "ฟุยูกิ", "tel": "087531264", "index": 3
				}, {
					"name": "โครอน", "type": "สุนัข", "age": 4, "gender": "Female",
					"description": "สีน้ำตาล ชอบวิ่งเล่น", "breed": "คอลลี่", "tag": ["ขี้เล่น", "ขี้อ้อน"], "imgurl": ["img/coron.jpg"], "owner": "ทามามะ", "tel": "0812478965", "index": 4
				}, {
					"name": "เฮงเฮง", "type": "สุนัข", "age": 12, "gender": "Male", "description": "สีขาวดำ",
					"breed": "-", "tag": ["ขี้เซา"], "imgurl": ["img/hengheng.jpg"], "owner": "เรนะ", "tel": "082235697", "index": 5
				}, {
					"name": "ลาเต้", "type": "สุนัข", "age": 6, "gender": "Male",
					"description": "สีน้ำตาลขาว รักเด็ก ดื้อมาก", "breed": "โกลเด้น", "tag": ["ขี้เล่น"], "imgurl": ["img/ลาเต้.jpg", "img/ลาเต้2.jpg"], "owner": "สมศรี", "tel": "0812478965", "index": 6
				}, {
					"name": "ตาล", "type": "สุนัข", "age": 2, "gender": "Male", "description": "กลัวคนแปลกหน้า ชอบกินข้าวคลุกกระดูกไก่สับ",
					"breed": "ชาเป่ย", "tag": ["ขี้กลัว", "ขี้อ้อน"], "imgurl": ["img/ตาล.jpg", "img/ตาล2.jpg"], "owner": "มิกิ", "tel": "087654234", "index": 7
				}, {
					"name": "บูบู้", "type": "สุนัข", "age": 3, "gender": "Male", "description": "สีดำทั้งตัว ",
					"breed": "พิตบู", "tag": ["ขี้เล่น", "ก้าวร้าว"], "imgurl": ["img/บูบู้.jpg", "img/บูบู้2.jpg"], "owner": "มิวะ", "tel": "084125453", "index": 8
				}, {
					"name": "ลินดา", "type": "สุนัข", "age": 4, "gender": "Female", "description": "รักเด็กผู้หญิง ชอบเล่นลูกบอล ชอบปีนป่าย กินอาหารเม็ด",
					"breed": "คอลลี่", "tag": ["ขี้เล่น", "ขี้อ้อน"], "imgurl": ["img/ลินดา.jpg", "img/ลินดา2.jpg"], "owner": "ลูลู่", "tel": "085425879", "index": 9
				}, {
					"name": "ปุ๊โกะ", "type": "สุนัข", "age": 2, "gender": "Female", "description": "สีขาว ชอบอาบน้ำ ว่ายน้ำ ชอบกินข้าวคลกน้ำพริก",
					"breed": "เครนเทอร์เรีย", "tag": ["ขี้เล่น", "ขี้อ้อน", "ขี้เซา"], "imgurl": ["img/ปุ๊โกะ.jpg", "img/ปุ๊โกะ.jpg"], "owner": "พีน่า", "tel": "082354587", "index": 10
				}],
				"cat": [{
					"name": "สิริ", "type": "แมว", "age": 2, "gender": "Female", "description": "สามสี ส้ม ขาว ดำ ชอบกินปลาทูทอด ขี้อ้อน กลัวหมา",
					"breed": "สามสี", "tag": ["ขี้เล่น", "ขี้อ้อน"], "imgurl": ["img/siri.jpg"], "owner": "คาคาชิ", "tel": "084251234", "index": 11
				}, {
					"name": "แฮปปี้", "type": "แมว", "age": 3, "gender": "Male", "description": "สีฟ้า ชอบนอน",
					"breed": "บริติชขนสั้น", "tag": ["ขี้เซา"], "imgurl": ["img/happy.jpg"], "owner": "ซากุระ", "tel": "084235125", "index": 12
				}, {
					"name": "มาจัง", "type": "แมว", "age": 1, "gender": "Female", "description": "สีขาวอมส้ม ชอบนั่งหน้าโทรทัศน์",
					"breed": "มันช์กิ้น", "tag": ["ขี้เล่น", "ขี้อ้อน"], "imgurl": ["img/maa.jpg"], "owner": "มิวกี้", "tel": "084523695", "index": 13
				}, {
					"name": "จี้จัง", "type": "แมว", "age": 1, "gender": "Female", "description": "สีขาว ชอบเล่นของเล่น",
					"breed": "สิงหะปุระ", "tag": ["ขี้อ้อน"], "imgurl": ["img/chi.jpg"], "owner": "โรส", "tel": "084531258", "index": 14
				}, {
					"name": "โลจัง", "type": "แมว", "age": 1, "gender": "Female", "description": "สีฟ้าเจือเงิน ชอบเล่นของเล่น",
					"breed": "รัสเซียนบลู", "tag": ["ขี้อ้อน"], "imgurl": ["img/ro.jpg", "img/ro2.jpg"], "owner": "ฟีโอน่า", "tel": "084532667", "index": 15
				}],
				"bird": [{
					"name": "คิริ", "type": "นก", "age": 3, "gender": "Male", "description": "สีเหลือง ขอบร้องเพลง",
					"breed": "คีรีบูน", "tag": ["ขี้เล่น"], "imgurl": ["img/kiri.jpg"], "owner": "ลูลิ", "tel": "081297546", "index": 16
				}, {
					"name": "นิจิ", "type": "นก", "age": 4, "gender": "Male", "description": "ชอบเกาะตามขอบตู้หรือเตียง",
					"breed": "เยลโล่ไซต์คอนนัว", "tag": ["ขี้กลัว"], "imgurl": ["img/niji.jpg"], "owner": "ราฟ", "tel": "087854699", "index": 17
				}, {
					"name": "ซันนี่", "type": "นก", "age": 2, "gender": "Female", "description": "ชอบบินมาเกาะ",
					"breed": "ซันคอนัว", "tag": ["ขี้้อ้อน"], "imgurl": ["img/sunny.jpg"], "owner": "มุกกี้", "tel": "082213569", "index": 18
				}, {
					"name": "ยูกิ", "type": "นก", "age": 3, "gender": "Female", "description": "ชอบเล่นไล่จับ",
					"breed": "นกกระตั้ว", "tag": ["ขี้เล่น"], "imgurl": ["img/yugi.jpg"], "owner": "โทรุ", "tel": "084538741", "index": 19
				}, {
					"name": "กิ๊ก", "type": "นก", "age": 2, "gender": "Female", "description": "ชอบร้องเพลง ชอบพูดตามคน",
					"breed": "แก้ว", "tag": ["ขี้เล่น"], "imgurl": ["img/กิ๊ก.jpg", "img/กิ๊ก2.jpg"], "owner": "เฟร", "tel": "084125378", "index": 20
				}],
				"mouse": [{
					"name": "พายุ", "type": "แฮมสเตอร์", "age": 1, "gender": "Male", "description": "ชอบวิ่ง ชอบกินธัญพืช ไม่ชอบอยู่เฉยๆ",
					"breed": "-", "tag": ["ขี้เล่น"], "imgurl": ["img/พายุ.jpg", "img/พายุ2.jpg"], "owner": "เลโอ", "tel": "082254369", "index": 21
				}],
				"rabbit": [{
					"name": "ทิปปี้", "type": "กระต่าย", "age": 4, "gender": "Female", "description": "สีขาว ขนนุ่มพู",
					"breed": "แองโกล่า", "tag": ["ขี้เล่น", "ขี้อ้อน"], "imgurl": ["img/tippy.jpg"], "owner": "แตงโม", "tel": "087321554", "index": 22
				}, {
					"name": "อันโกะ", "type": "กระต่าย", "age": 3, "gender": "Male", "description": "สีดำ ชอบนั่งอยู่นิ่งๆ",
					"breed": "แองโกล่า", "tag": ["ขี้เซา"], "imgurl": ["img/anko.jpg"], "owner": "จูเนีย", "tel": "081124583", "index": 23
				}, {
					"name": "ชิรอน", "type": "กระต่าย", "age": 3, "gender": "Female", "description": "สีขาว ชอบเล่นในกล่อง",
					"breed": "อิงลิซ ล็อป", "tag": ["ขี้เล่น"], "imgurl": ["img/shiron.jpg"], "owner": "เกม", "tel": "083526748", "index": 24
				}, {
					"name": "โรโกะ", "type": "กระต่าย", "age": 2, "gender": "Female", "description": "สีขาว ตื่นคนแปลกหน้า",
					"breed": "เท็ดดี้แบร์ ", "tag": ["ขี้กลัว"], "imgurl": ["img/roko.jpg"], "owner": "แป้ง", "tel": "087758412", "index": 25
				}, {
					"name": "เจอรี่", "type": "กระต่าย", "age": 1, "gender": "Male", "description": "สีน้ำตาาล ตื่นเสียงสุนัข",
					"breed": "เจอร์รี่วู๊ดดี้ ", "tag": ["ขี้กลัว", "ขี้อ้อน"], "imgurl": ["img/jerry.jpg"], "owner": "พลอย", "tel": "084258112", "index": 26
				}, {
					"name": "วินดี้", "type": "กระต่าย", "age": 2, "gender": "Female", "description": "สีขาว ชอบกินผักบุ้ง เป็นมิตร",
					"breed": "ฮอลแลนด์ลอป", "tag": ["ขี้เซา"], "imgurl": ["img/วินดี้.jpg"], "owner": "อ๊อฟ", "tel": "085423966", "index": 27
				}, {
					"name": "เท็ดดี้", "type": "กระต่าย", "age": 3, "gender": "Male", "description": "สีขาว ชอบวิ่ง ซน",
					"breed": "เท็ดดี้แบร์", "tag": ["ขี้เล่น"], "imgurl": ["img/เท็ดดี้.jpg", "img/เท็ดดี้2.jpg", "img/เท็ดดี้3.jpg"], "owner": "ซัน", "tel": "088857439", "index": 28
				}],
				"other": [{
					"name": "มีมี่", "type": "เม่นแคระ", "age": 2, "gender": "Male", "description": "ขี้หนาว กลัวน้ำ กินอาหารแมวMeo ไม่ชอบเล่นด้วย จะขู่",
					"breed": "เฮดจ์ฮอก", "tag": ["ขี้กลัว", "ขี้เซา"], "imgurl": ["img/มีมี่.jpg", "img/มีมี่2.jpg"], "owner": "ปราง", "tel": "085744861", "index": 29
				}, {
					"name": "โซจิโร่", "type": "เม่น", "age": 2, "gender": "Male", "description": "ชอบกินแอปเปิล",
					"breed": "-", "tag": ["ขี้เซา", "ขี้อ้อน"], "imgurl": ["img/sojiro.jpg", "img/sojiro2.jpg"], "owner": "สมศรี", "tel": "0812478965", "index": 30
				}]
			}
		};
